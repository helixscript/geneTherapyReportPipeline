...
# HERE
ii <- which(summaryTable$GTSP == 'GTSP5381')
summaryTable$VCN <- as.character(summaryTable$VCN)
if(length(ii) == 1) summaryTable[ii,]$VCN <- 'FDP1: 2.73 / FDP2: 3.10'
...
```{r, echo=FALSE, results='asis'}
library(xtable)
print(xtable(maxRelAbundTbl, align='llllclc'), comment=FALSE, include.rownames = FALSE)
```
